...
class SlackAIAgent {
    constructor() {
        ...
        this.openai = new ChatGoogleGenerativeAI({
    ...
    async analyzeWithAI(memberInfo, researchData) {
        const prompt = ChatPromptTemplate.fromTemplate(
            `Analyze this new community member for fit with out commercial product.
